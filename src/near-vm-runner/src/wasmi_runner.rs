...
// impl IntoVMError for wasmi::Error::Instantiation {
...
// impl IntoVMError for wasmi::Error::Function {
//     fn into_vm_error(self) -> VMError {
//         match self {
//             str => VMError::FunctionCallError(
//                 FunctionCallError::MethodResolveError(MethodResolveError::MethodInvalidSignature),
//             ),
//             // wasmi::Error::Function(str) => VMError::FunctionCallError(
